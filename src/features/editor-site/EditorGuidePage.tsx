...
const GUIDE_STEPS = [
  ...
  },
  {
    ...
    description: 'Generate a public link when you want feedback, or remix a shared project into your own account.',
    icon: Share2,
  },
] as const;
          ...
          <div className="grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="rounded-[2rem] border border-white/8 bg-white/[0.03] p-6 shadow-[0_20px_64px_rgba(3,7,18,0.24)] sm:p-8">
              ...
              <div className="mt-5 space-y-5 text-sm leading-7 text-white/60">
                ...
                <p>Autosave keeps the workspace updated every two seconds, and local development mode still uses local storage in development.</p>
                <p>Public shared project views remain available through their existing share routes, so remix links continue to work after the restructure.</p>
              </div>
            </div>
          </div>
        </Reveal>
