...
const FEATURE_SECTIONS = [
  ...
  },
  {
    ...
    points: ['Public project sharing', 'Read-only viewer experience', 'One-click remix into a signed-in account'],
    icon: Share2,
  },
  {
    title: 'Autosave',
    eyebrow: 'Reliability',
    description:
      'Yantra keeps work safe by autosaving every two seconds and supporting local development mode for offline or bypassed workflows while preserving the editor behavior users already rely on.',
    points: ['Frequent autosave cadence', 'Local dev storage support', 'Designed to reduce accidental work loss'],
    icon: SaveAll,
  },
] as const;

export default function EditorFeaturesPage() {
  return (
    <EditorSiteShell>
      <main className="mx-auto max-w-7xl px-4 pb-20 pt-10 sm:px-6 lg:px-8">
        <Reveal className="max-w-4xl py-10 sm:py-16">
